...
<template>
  <div class="h-[1000px]">
    ...
    <el-button type="success" round @click.native="settingHandler && settingHandler('language', 'zh_cn')">按我1</el-button>

    <el-button type="info" round @click.native="handeler('id_ID')">按我2</el-button>

    <el-button type="warning" round @click.native="settingHandler && settingHandler('theme', 'dark')">按我3</el-button>
